...
/*
Plugin Name:  Category - RSS widget menu
Version: v1.0
Description: A simple Wordpress plugin to add category and  RSS menu into your posts, pages, sidebars.
Plugin URI: http://ukras.info/category-rss-widget-menu/ 
Author: randy75
Author URI: http://ukras.info/category-rss-widget-menu/ 
...
add_option('rss-categ_1_name', 'All Topics');
...
function show_specific_categories()
{
    ...
    $rss_cat_1_name_value = get_option('rss-categ_1_name');
    $rss_cat_1_link_value = get_option('rss-categ_1_link');

    $rss_cat_2_name_value = get_option('rss-categ_2_name');
    $rss_cat_2_link_value = get_option('rss-categ_2_link');

    $rss_cat_3_name_value = get_option('rss-categ_3_name');
    $rss_cat_3_link_value = get_option('rss-categ_3_link');

    $rss_cat_4_name_value = get_option('rss-categ_4_name');
    $rss_cat_4_link_value = get_option('rss-categ_4_link');

    $rss_cat_5_name_value = get_option('rss-categ_5_name');
    $rss_cat_5_link_value = get_option('rss-categ_5_link');

    $rss_cat_6_name_value = get_option('rss-categ_6_name');
    $rss_cat_6_link_value = get_option('rss-categ_6_link');

    $rss_cat_7_name_value = get_option('rss-categ_7_name');
    $rss_cat_7_link_value = get_option('rss-categ_7_link');

    $rss_cat_8_name_value = get_option('rss-categ_8_name');
    $rss_cat_8_link_value = get_option('rss-categ_8_link');
    	
	// Display and configure setting
    // best solution
...
function category_specific_option_page() {
    ...
    if (isset($_POST['info_update']))
    {
        ...
        update_option('rss-categ_1_name', (string)$_POST["rss-categ_1_name"]);
        update_option('rss-categ_1_link', (string)$_POST["rss-categ_1_link"]);

        update_option('rss-categ_2_name', (string)$_POST["rss-categ_2_name"]);
        update_option('rss-categ_2_link', (string)$_POST["rss-categ_2_link"]);

        update_option('rss-categ_3_name', (string)$_POST["rss-categ_3_name"]);
        update_option('rss-categ_3_link', (string)$_POST["rss-categ_3_link"]);

        update_option('rss-categ_4_name', (string)$_POST["rss-categ_4_name"]);
        update_option('rss-categ_4_link', (string)$_POST["rss-categ_4_link"]);

        update_option('rss-categ_5_name', (string)$_POST["rss-categ_5_name"]);
        update_option('rss-categ_5_link', (string)$_POST["rss-categ_5_link"]);

        update_option('rss-categ_6_name', (string)$_POST["rss-categ_6_name"]);
        update_option('rss-categ_6_link', (string)$_POST["rss-categ_6_link"]);

        update_option('rss-categ_7_name', (string)$_POST["rss-categ_7_name"]);
        update_option('rss-categ_7_link', (string)$_POST["rss-categ_7_link"]);

        update_option('rss-categ_8_name', (string)$_POST["rss-categ_8_name"]);
        update_option('rss-categ_8_link', (string)$_POST["rss-categ_8_link"]);
    ...
    <input name="rss-categ_1_name" type="text" size="20" value="<?php echo get_option('rss-categ_1_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_1_link" type="text" size="40" value="<?php echo get_option('rss-categ_1_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 2 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_2_name" type="text" size="20" value="<?php echo get_option('rss-categ_2_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_2_link" type="text" size="40" value="<?php echo get_option('rss-categ_2_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 3 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_3_name" type="text" size="20" value="<?php echo get_option('rss-categ_3_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_3_link" type="text" size="40" value="<?php echo get_option('rss-categ_3_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 4 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_4_name" type="text" size="20" value="<?php echo get_option('rss-categ_4_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_4_link" type="text" size="40" value="<?php echo get_option('rss-categ_4_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 5 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_5_name" type="text" size="20" value="<?php echo get_option('rss-categ_5_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_5_link" type="text" size="40" value="<?php echo get_option('rss-categ_5_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 6 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_6_name" type="text" size="20" value="<?php echo get_option('rss-categ_6_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_6_link" type="text" size="40" value="<?php echo get_option('rss-categ_6_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 7 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_7_name" type="text" size="20" value="<?php echo get_option('rss-categ_7_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_7_link" type="text" size="40" value="<?php echo get_option('rss-categ_7_link'); ?>"/>
    </td></tr>

    <tr valign="top"><td width="15%" align="left">
    <strong>Category 8 Name: </strong>
    </td><td align="left">
    <input name="rss-categ_8_name" type="text" size="20" value="<?php echo get_option('rss-categ_8_name'); ?>"/>
    <strong>RSS Link: </strong><input name="rss-categ_8_link" type="text" size="40" value="<?php echo get_option('rss-categ_8_link'); ?>"/>
    </td></tr>
